...
use crate::domain::n004_snapshot_aggregate::ui::list::ListState as AggregatesListState;
...
impl CentralPanel {
    ...
    pub fn show(
        ...
        snapshot_aggregates_state: &mut AggregatesListState,
